...
X_train = np.genfromtxt("../data/mnist.data.train", max_rows=800)
y_train = np.genfromtxt("../data/mnist.labels.train", max_rows=800)
X_test = np.genfromtxt("../data/mnist.data.test", max_rows=200)
y_test = np.genfromtxt("../data/mnist.labels.test", max_rows=200)
